...
import './userProfileFormFields.scss'
...
function FieldErrors(props: { attribute: Attribute; displayableErrors: FormFieldError[]; fieldIndex: number | undefined; kcClsx: KcClsx }) {
    ...
    console.log("Displayable Errors",displayableErrors)
...
function InputTag(props: InputFieldByTypeProps & { fieldIndex: number | undefined }) {
    ...
    console.log("Display error",displayableErrors);
    ...
    useEffect(() => {
        if (attribute.name.includes('password')) {
            ...
            // const passwordInputElement = document.getElementById(passwordInputId);
            const passwordInputElement = document.getElementById(attribute.name);
    ...
    return (
        <>
            <TextField
                ...
                id={attribute.name}
                label={<div style={{ color: 'black' }}>{advancedMsgStr(attribute.displayName ?? 'default string')}</div>}
                inputProps={{
                ...
                InputProps={{
                    endAdornment: (
                        <InputAdornment position="end">
                            {
                                attribute.name.includes('password') &&
                                (<IconButton
